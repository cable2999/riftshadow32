...
bool    check_social    args( ( CHAR_DATA *ch, char *command,
                char *argument ) );
bool    knows_command   args((CHAR_DATA *ch,int cmd));
...
//  { "name",       do_fun,     position,   level,  log,    show,hide, "skill_name" },
    /*
    ...
    { "lore",       do_lore,        POS_DEAD,        0,  LOG_NORMAL, 1, 0, "lore" },
    { "cleader",    do_leader,      POS_DEAD,       L2,  LOG_ALWAYS, 1, 0, "none" },
    { "i",          do_inventory,   POS_DEAD,        0,  LOG_NORMAL, 0, 1, "none" },
    { "in",         do_inventory,   POS_DEAD,        0,  LOG_NORMAL, 0, 1, "none" },
    ...
    { "/",          do_recall,      POS_STANDING,    0,  LOG_NORMAL, 0, 1, "none" },
    ...
    { "demand",     do_demand,      POS_STANDING,    0,  LOG_NORMAL, 1, 1, "demand" },
    /*
...
//  { "news",       do_news,        POS_DEAD,        0,  LOG_NORMAL, 1, 0, "none" },
    ...
    { "read",       do_look,        POS_RESTING,     0,  LOG_NORMAL, 0, 1, "none" },
...
//  { "unalias",    do_unalias,     POS_DEAD,        0,  LOG_NORMAL, 1, 0, "none" },
    ...
    { "pmote",      do_pmote,       POS_RESTING,    ML,  LOG_NORMAL, 1, 0, "none" },
...
/* Newbie command by Dev */
    ...
    { "[",          do_whisper,     POS_RESTING,     0,  LOG_NORMAL, 0, 1, "none" },
     ...
     */
    { "brandish",   do_brandish,    POS_RESTING,     0,  LOG_NORMAL, 1, 1, "staves" },
    ...
    { "embalm",     do_embalm,      POS_STANDING,    0,  LOG_NORMAL, 0, 1, "embalm" },
    { "eat",        do_eat,         POS_RESTING,     0,  LOG_NORMAL, 1, 1, "none" },
    { "envenom",    do_envenom,     POS_RESTING,     0,  LOG_NORMAL, 1, 1, "envenom" },
    ...
    { "pick",       do_pick,        POS_RESTING,     0,  LOG_NORMAL, 1, 1, "pick lock" },
    ...
    { "recite",     do_recite,      POS_RESTING,     0,  LOG_NORMAL, 1, 1, "scrolls" },
    { "remove",     do_remove,      POS_RESTING,     0,  LOG_NORMAL, 1, 1, "none" },
    { "roll",       do_roll,        POS_RESTING,     0,  LOG_NORMAL, 1, 1, "none" },
    { "doorbash",   do_door_bash,   POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "door bash" },
    { "headbutt",   do_headbutt,    POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "headbutt" },
    { "silentmovement", do_silent_movement, POS_FIGHTING, 0, LOG_NORMAL, 1, 0, "silent movement" },
    { "gore",       do_gore,        POS_STANDING,    0,  LOG_NORMAL, 1, 1, "gore" },
...
//  { "listvotes",  do_listvotes,   POS_DEAD,        0,  LOG_NORMAL, 1, 0, "none"  },
    { "zap",        do_zap,         POS_RESTING,     0,  LOG_NORMAL, 1, 1, "wands" },
    { "vanish",     do_vanish,      POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "vanish" },
//  { "aura",do_aura_of_sustenance, POS_RESTING,     0,  LOG_NORMAL, 1, 1, "none" },
    ...
    { "cleave",     do_cleave,      POS_STANDING,    0,  LOG_NORMAL, 0, 0, "cleave" },
    { "herb",       do_herb,        POS_STANDING,    0,  LOG_NORMAL, 0, 0, "herb" },
    { "records",    do_records,     POS_SLEEPING,    0,  LOG_NORMAL, 0, 0, "none" },
    { "ambush",     do_ambush,      POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "ambush" },
    { "pugil",      do_pugil,       POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "pugil" },
    { "lash",       do_lash,        POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "lash" },
    { "shieldcleave",do_shield_cleave,POS_FIGHTING,  0,  LOG_NORMAL, 0, 1, "shield cleave" },
    { "backstab",   do_backstab,    POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "backstab" },
    { "knife",      do_knife,       POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "knife" },
    { "bash",       do_bash,        POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "bash" },
    { "throw",      do_throw,       POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "throw" },
    { "strangle",   do_strangle,    POS_STANDING,    0,  LOG_NORMAL, 1, 0, "strangle" },
    { "blindness",  do_blindness_dust, POS_FIGHTING, 0,  LOG_NORMAL, 0, 1, "blindness dust" },
    { "poison",     do_poison_dust, POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "poison dust" },
    { "warcry",     do_warcry,      POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "warcry" },
    { "endure",     do_endure,      POS_STANDING,    0,  LOG_NORMAL, 1, 1, "endure" },
    { "nerve",      do_nerve,       POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "nerve" },
//  { "ram",        do_ram,         POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "none" },
    { "tail",       do_tail,        POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "none" },
    { "blackjack",  do_blackjack,   POS_STANDING,    0,  LOG_NORMAL, 1, 0, "blackjack" },
    { "bj",         do_blackjack,   POS_STANDING,    0,  LOG_NORMAL, 0, 0, "blackjack" },
    { "bs",         do_backstab,    POS_FIGHTING,    0,  LOG_NORMAL, 0, 0, "backstab" },
    { "berserk",    do_berserk,     POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "berserk" },
    { "circle",     do_circle_stab, POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "circle" },
    { "darksight",  do_darksight,   POS_STANDING,    0,  LOG_NORMAL, 1, 1, "darksight" },
    { "detect",     do_detect_hidden, POS_STANDING,  0,  LOG_NORMAL, 1, 0, "detect hidden" },
    { "bluff",      do_bluff,       POS_STANDING,    0,  LOG_NORMAL, 1, 1, "bluff" },
    { "falsemotives",do_false_motives,POS_STANDING,  0,  LOG_NORMAL, 1, 1, "false motives" },
    { "dirt",       do_dirt,        POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "dirt kicking" },
    { "disarm",     do_disarm,      POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "disarm" },
    { "disengage",  do_disengage,   POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "none" },
    { "flee",       do_flee,        POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "none" },
    { "kick",       do_kick,        POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "kick" },
    { "murde",      do_murde,       POS_FIGHTING,    0,  LOG_NORMAL, 0, 0, "none" },
    { "murder",     do_murder,      POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "none" },
    { "rescue",     do_rescue,      POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "rescue" },
    { "trip",       do_trip,        POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "trip" },
    { "defend",     do_defend,      POS_FIGHTING,    0,  LOG_NORMAL, 1, 0, "defend" },
    { "assassinate",do_assassinate, POS_STANDING,    0,  LOG_NORMAL, 0, 1, "assassinate" },
    { "forage",     do_forage,      POS_STANDING,    0,  LOG_NORMAL, 1, 1, "forage" },
    { "protection", do_protection_heat_cold, POS_STANDING, 0, LOG_NORMAL, 1, 1, "protection heat cold"  },
    { "intimidate", do_intimidate,  POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "intimidate" },
    { "bind",       do_bind,        POS_STANDING,    0,  LOG_NORMAL, 0, 0, "bind" },
    { "unbind",     do_unbind,      POS_FIGHTING,    0,  LOG_NORMAL, 0, 1, "none" },
    { "charge",     do_charge,      POS_STANDING,    0,  LOG_NORMAL, 0, 0, "charge" },
    { "offhand",    do_offhand,     POS_FIGHTING,    0,  LOG_NORMAL, 0, 0, "offhand disarm" },
...
//  { "blast",      do_blast,       POS_FIGHTING,    0,  LOG_NEVER,  0, 0, "none" },
    ...
    { "storytell",  do_storytell,   POS_RESTING,     0,  LOG_NEVER,  0, 0, "story tell" },
    { "entrap",     do_entrap,      POS_FIGHTING,    0,  LOG_NORMAL, 0, 0, "entrap" },
    { "drive",      do_drive,       POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "drive" },
    { "dash",       do_dash,        POS_STANDING,    0,  LOG_NORMAL, 1, 1, "dash" },
    { "howl",       do_howl,        POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "howl" },
    ...
    { "drain",      do_drain,       POS_STANDING,    0,  LOG_NORMAL, 0, 0, "drain" },
    ...
    { "turnundead", do_turn_undead, POS_FIGHTING,    0,  LOG_NORMAL, 0, 0, "turn undead" },
    ...
    { "creep",      do_creep,       POS_STANDING,    0,  LOG_NORMAL, 1, 0, "creep" },
    { "scan",       do_scan,        POS_RESTING,     0,  LOG_NORMAL, 1, 0, "none" },
    { "gain",       do_gain,        POS_STANDING,    0,  LOG_NORMAL, 1, 0, "none" },
//  { "groups",     do_groups,      POS_SLEEPING,    0,  LOG_NORMAL, 1, 0, "none" },
    { "acute",      do_acute_vision,POS_STANDING,    0,  LOG_NORMAL, 1, 0, "acute vision" },
    { "barkskin",   do_barkskin,    POS_STANDING,    0,  LOG_NORMAL, 1, 0, "barkskin" },
    { "animal",     do_animal_call, POS_STANDING,    0,  LOG_NORMAL, 1, 0, "animal call" },
    { "enlist",     do_enlist,      POS_STANDING,    0,  LOG_NORMAL, 1, 0, "enlist" },
    { "camouflage", do_camouflage,  POS_STANDING,    0,  LOG_NORMAL, 1, 0, "camouflage" },
    { "camp",       do_camp,        POS_RESTING,     0,  LOG_NORMAL, 1, 1, "camp" },
    { "hide",       do_hide,        POS_RESTING,     0,  LOG_NORMAL, 1, 0, "hide" },
    { "laying",     do_laying_hands,POS_STANDING,    0,  LOG_NORMAL, 1, 0, "laying hands" },
    ...
    { "tame",       do_tame,        POS_FIGHTING,    0,  LOG_NORMAL, 1, 1, "tame" },
    { "find water", do_find_water,  POS_STANDING,    0,  LOG_NORMAL, 1, 1, "find water" },
    { "fw",         do_find_water,  POS_STANDING,    0,  LOG_NORMAL, 0, 1, "find water" },
//  { "track",      do_track,       POS_RESTING,     0,  LOG_NORMAL, 1, 1, "none" },
    ...
    { "sneak",      do_sneak,       POS_STANDING,    0,  LOG_NORMAL, 1, 0, "sneak" },
    { "split",      do_split,       POS_RESTING,     0,  LOG_NORMAL, 1, 1, "none" },
    { "steal",      do_steal,       POS_STANDING,    0,  LOG_NEVER,  1, 0, "steal" },
    { "plant",      do_plant,       POS_STANDING,    0,  LOG_NEVER,  1, 0, "plant" },
    { "gag",        do_gag,         POS_STANDING,    0,  LOG_NEVER,  1, 0, "gag" },
    { "ungag",      do_ungag,       POS_STANDING,    0,  LOG_NEVER,  1, 0, "none" },
    { "drag",       do_drag,        POS_STANDING,    0,  LOG_NEVER,  1, 0, "drag" },    
    { "sign",       do_sign,        POS_STANDING,    0,  LOG_NEVER,  1, 0, "sign" },
    { "slash",      do_slash,       POS_STANDING,    0,  LOG_NEVER,  1, 0, "slash" },
    { "tripwire",   do_tripwire,    POS_STANDING,    0,  LOG_NEVER,  1, 0, "tripwire" },
    { "stash",      do_stash,       POS_STANDING,    0,  LOG_NEVER,  1, 0, "stash" },
    { "disguise",   do_disguise,    POS_STANDING,    0,  LOG_NEVER,  1, 1, "disguise" },
    { "undisguise", do_undisguise,  POS_STANDING,    0,  LOG_NEVER,  1, 1, "disguise" },
    { "shadowcloak",do_shadow_cloak,POS_STANDING,    0,  LOG_NEVER,  1, 1, "shadow cloak" },
    { "search",     do_search,      POS_STANDING,    0,  LOG_NEVER,  1, 0, "none" },
    { "counterfeit",do_counterfeit, POS_STANDING,    0,  LOG_NEVER,  1, 0, "counterfeit" },
    { "strip",      do_strip,       POS_STANDING,    0,  LOG_NEVER,  1, 0, "strip" },
    ...
    { "cloak",      do_cloak,       POS_STANDING,    0,  LOG_NORMAL, 1, 0, "cloak" },
    { "hometown",   do_hometown,    POS_RESTING,     0,  LOG_ALWAYS, 1, 1, "none" },
    { "invoke",     do_invoke,      POS_DEAD,        0,  LOG_NORMAL, 1, 1, "none" },
    { "snare",      do_snare,       POS_STANDING,    0,  LOG_NORMAL, 0, 0, "snare" },
    { "bearcall",   do_bear_call,   POS_STANDING,    0,  LOG_ALWAYS, 0, 0, "bear call" },
    ...
    { "taunt",      do_taunt,       POS_STANDING,    0,  LOG_NORMAL, 1, 1, "taunt" },
    { "consume",    do_consume,     POS_STANDING,    0,  LOG_NORMAL, 1, 1, "consume" },
    { "breathofmephisto", do_breath_mephisto, POS_FIGHTING, 0, LOG_NORMAL, 1, 1, "breath of mephisto" },
...
//  { "goto",       do_goto,        POS_DEAD,   L8,  LOG_NORMAL, 1, 0, "none" },
    ...
    { "pswitch",    do_pswitch,     POS_DEAD,   ML,  LOG_ALWAYS, 1, 0, "none"  },
...
//  { "damage",     do_damage,      POS_DEAD,   L3,  LOG_ALWAYS, 1, 0, "none" },
     ...
     * OLC
     */
    { "edit",       do_olc,         POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
    { "asave",      do_asave,       POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
//  { "alist",      do_alist,       POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
    { "resets",     do_resets,      POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
    { "redit",      do_redit,       POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
    { "medit",      do_medit,       POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
    { "aedit",      do_aedit,       POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
    { "oedit",      do_oedit,       POS_DEAD,   ML,  LOG_NORMAL, 1, 0, "none" },
...
void interpret( CHAR_DATA *ch, char *argument )
{
    ...
    int i;
    AFFECT_DATA *paf;
    CHAR_DATA *victim = NULL; OBJ_DATA *obj,*vpobj = NULL;
    ...
    return send_to_char( "You're totally frozen!\n\r", ch );
    ...
    if (!str_prefix("qc",command))
        return clear_cmd_queue(ch);

    if (ch->wait > 0 && !IS_NPC(ch))
    {
        if(ch->pcdata->write_next > (MAX_QUEUE-1)) {
            return send_to_char("Command queue full.\n\r", ch);
        }
...
//      send_to_char(buf,ch);
    ...
    if (!IS_NPC(ch) && (is_affected(ch,gsn_hold_person)
        || ch->pcdata->energy_state < -4)
        && get_trust(ch)<MAX_LEVEL
        && cmd_table[cmd].name != "immtalk"
        && cmd_table[cmd].name != "astrip")
        return send_to_char("You are totally frozen!\n\r",ch);
    ...
    if (is_affected(ch,gsn_creeping_tomb)) {
        ...
        && (cmd_table[cmd].name != "astrip")
        && (cmd_table[cmd].name != "immtalk"))
            return send_to_char("You are entombed in ooze and cannot move.\n\r",ch);
    }
    ...
    if (is_affected(ch,gsn_ultradiffusion)
        ...
        return send_to_char("You cannot do that while your molecules are diffused from your body.\n\r",ch);

    for ( cmd2 = 0; social_table[cmd2].name[0] != '\0'; cmd2++ )
        if ( command[0] == social_table[cmd2].name[0]
            && !str_prefix( command, social_table[cmd2].name ) ) {
            is_social = TRUE;
            break;
        }
    ...
    if (vprog && ((vpobj = get_obj_here(ch,object)) != NULL)
        && (vpobj->pIndexData->verb)
        && (!str_cmp(command,vpobj->pIndexData->verb)
            ...
            if(!str_cmp(cmd_table[cmd].skill_name,skill_table[skill_num].name))
                if((gn = gn_skill_lookup(skill_num)) > 1)
                    if(str_cmp(group_table[gn].name,style_table[ch->pcdata->style].name))
                        return send_to_char("You are not in the proper style.\n\r",ch);
    }
    ...
    case TAR_CHAR_OFFENSIVE:
        if ( argument[0] == '\0' )
        {
            if ( ( victim = ch->fighting ) == NULL )
                return send_to_char( "Do that to who?\n\r", ch );
        }
        else
        {
    ...
    case TAR_CHAR_SELF:
        if ( argument[0] != '\0' && !is_name( argument, ch->name ) )
                return send_to_char( "You can't do that to someone else.\n\r", ch );
        vo = (void *) ch;
        break;
    case TAR_OBJ_INV:
        if (argument[0] == '\0' )
                return send_to_char( "What do you want to do that to?\n\r", ch );
